...
final class APIService {
    ...
    func getWordPhonetics(for word: String,  completion: @escaping(Result<[Phonetics], Error>) -> Void) {
        ...
        let task = URLSession.shared.dataTask(with: request) { data, res, error in
            ...
            do {
                ...
                for each in response {
                    ...
                    print("Meu response: \(each.phonetics)")
                    completion(.success(each.phonetics ?? []))
                }
